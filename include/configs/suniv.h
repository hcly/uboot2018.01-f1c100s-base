...
#define CONFIG_BOOTCOMMAND "spi_nand probe 0; spi_nand read 80500000 200000 500000; spi_nand read 80c00000 700000 10000; bootz 80500000 - 80c00000"
#else
...
"mtdpartsx=spi0.0:2048k(uboot)ro,5120k(kernel)ro,64k(script),-(rootfs)\0" \
